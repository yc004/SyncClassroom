...
const config = {
    ...
    // 缓存目录配置
    cacheRoot: process.env.LUMESYNC_CACHE_DIR || path.join(__dirname, '..', 'public'),
    libDir: process.env.LUMESYNC_LIB_DIR || path.join(
        process.env.LUMESYNC_CACHE_DIR || path.join(__dirname, '..', 'public'),
        'lib'
    ),
    ...
    // 课程目录
    coursesDir: path.join(__dirname, '..', 'public', 'courses'),

    // 文件夹数据路径
    folderDataPath: path.join(__dirname, '..', 'public', 'data', 'course-folders.json'),
    ...
    // 座位表配置
    classroomLayoutPath: path.join(__dirname, '..', 'public', 'data', 'classroom-layout-v1.json'),

    // 教程文档路径
    skillPath: path.join(__dirname, '..', 'docs', 'create-course.md'),
    courseGuidePath: path.join(__dirname, '..', 'docs', 'course-template.md'),
